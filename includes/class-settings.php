...
class Settings {
    ...
    public function register_settings() {
        ...
        add_settings_section('rs_block_section', 'Order Blocking Rules :', function () {
        ...
        // -------------------Design section-------------------
        add_settings_section('popup_design_section', 'Order Blocking Alert Design :', function () {
    ...
    public function sanitize_options($input) {
        ...
        foreach ($this->default_opts as $key => $default) {
            if (in_array($key, ['enable_blocking', 'enable_call_button', 'enable_whatsapp_button', 'enable_number_validation'])) {
