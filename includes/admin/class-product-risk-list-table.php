...
class Product_Risk_List_Table extends WP_List_Table {
	...
	public function get_sortable_columns() {
		return array(
			'total'       => array( 'total_orders', false ),
			'returns'     => array( 'failed_orders', false ),
			'return_rate' => array( 'fraud_rate', false ),
		);
	}
	...
	public static function handle_export() {
		if (
			...
			fputcsv( $output, array( 'Product Name', 'Product ID', 'Return Rate (%)', 'Returns', 'Total Ordered' ) );
