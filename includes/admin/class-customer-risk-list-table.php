...
class Customer_Risk_List_Table extends \WP_List_Table {
	...
	protected function get_sortable_columns() {
		return array(
			...
			'return_rate'    => array( 'return_rate', false ),
			'returned_count' => array( 'returned_count', false ),
	...
	public static function handle_export() {
		if (
			...
			fputcsv( $output, array( 'Customer ID', 'Name', 'Email', 'Return Rate (%)', 'Returned Count', 'Orders', 'Blocked' ) );
